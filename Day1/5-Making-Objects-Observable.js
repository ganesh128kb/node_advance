...
FindPattern.prototype.find = function () {
    ...
    self.files.forEach(function (file) {
        fs.readFile(file, 'utf8', function (err, content) {
            ...
            var match = null;
            if (match = content.match(self.regex)) match.forEach(function (elem) {
...
//Usage of FindPattern- To be put in separate file
var findPatternObject = new FindPattern(/hello \w+/);
findPatternObject.addFile('fileA.txt').addFile('fileB.json').find().on('found', function (file, match) {
